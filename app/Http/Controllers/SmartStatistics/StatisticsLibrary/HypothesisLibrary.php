<?php
    ...
    use App\Http\Controllers\SmartStatistics\StatisticsLibrary\DistributionLibrary;
    use App\Http\Controllers\SmartStatistics\StatisticsLibrary\MethodsLibrary;
    ...
    class HypothesisLibrary {
        ...
        public function hypoOneSample($arr){
            ...
            if($arr[0]=="td"){
                ...
                return array('test_type'=> 't', 'hypothesis'=>$text, 't_calculated'=>$tcal, 't_tabular'=>$ttab, 'data_mean'=>$xbar, 'population_mean'=>$popbar, 'standard_deviation'=>$stdv, 'level_of_significance'=>$arr[2][2], 't_tab_critical'=>$tcrit, 't_prob_dist_function'=>$tpdf, 't_cum_dist_function'=>$tcdf, 't_cal_critical'=>$tcalarr);
            }
            else if($arr[0]=="zd"){
                $ntail=(int)$arr[2][0];
                $n=count($arr[1]);
                ...
                return array('test_type'=> 'z', 'hypothesis'=>$text, 'z_calculated'=>$zcal, 'z_tabular'=>$ztab, 'data_mean'=>$xbar, 'population_mean'=>$popbar, 'standard_deviation'=>$stdv, 'level_of_significance'=>$arr[2][3], 'z_tab_critical'=>$zcrit, 'z_prob_dist_function'=>$zpdf, 'z_cum_dist_function'=>$zcdf, 'z_cal_critical'=>$zcalarr);
            } 
        }
